...
DANMAP %>% 
  ...
  setView(lng = 8.948, lat = 56.128, zoom = 14)
...
# Vi har tidligere oppe i arbejdet tilføjet noter til de respræktive punkter.
# Dette skete i task 3, hvor følgende linje blev tilføjet: "popup = places$Description"
# Man kan se punkternes tilhørende npter ved at klikke på punkterne på kortet.
